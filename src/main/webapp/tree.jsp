...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"${pageContext.request.contextPath }/students/query"},
	{ level:1, name:"教师管理"},
	{ level:2, name:"教师列表", ico:"images/icon_default.gif",link:"${pageContext.request.contextPath }/teachers/query"},
	{ level:1, name:"信息管理"},
